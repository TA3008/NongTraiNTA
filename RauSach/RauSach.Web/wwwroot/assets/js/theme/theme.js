...
(function ($) {
    ...
    //                $('.con_message', $this).fadeIn().html('<strong>Chúc mừng!</strong> Gửi tin nhắn thành công.').removeClass('alert-warning').addClass('alert-success');
    //                setTimeout(function () {
    ...
    //    } else {
    //        $('button[type="submit"]', $this).removeAttr('disabled').val('Message');
    //        $('.con_message', $this).fadeIn().html('<strong>Opps!</strong> Có lỗi xảy ra.').removeClass('alert-success').addClass('alert-warning');
    //        setTimeout(function () {
    //            $('.con_message', $this).fadeOut().html('').removeClass('alert-success alert-warning');
    //        }, 5000);
    //    }
